            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><h1><span class="highlight">UPDATE ADVISORIES HEADER DETAILS</span></h1></li>
                    </ol>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">           
			...
			<div class="col-sm-4 to_animate" data-animation="fadeInLeft">
				...
				<strong>Advisory header: </strong> <input type="text" id="firstname"name="firstname" size="30"value="<?php echo $firstname; ?>" maxlength="30" /><br/>
				</div>
				<input type="submit" id="advisory-edit-header" name="submit" value="Update" class="theme_button">
...
<div class="preloader">
    <div class="preloader_image"></div>
		...
		<script src="js/advisory_header_add_edit_validator.js"></script>
