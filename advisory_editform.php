<?php
	...
	{
		header("Location: advisory_details_index.php");
	}
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='advisory_details_index.php';
				</script>
                <?php
			}
			else{
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><h1><span class="highlight">UPDATE ADVISORIES DETAILS</span></h1></li>
                    </ol>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="widget col-sm-6  to_animate animated fadeInLeftBig" data-animation="fadeInLeftBig" data-delay="250">
                <form class="advisory-edit-form"  enctype="multipart/form-data" method="post" >
				
                    <p class="advisory-edit-form-advisory-header">
                        <label for="name">Advisory header <span class="required">*</span></label>
                        <input type="text" aria-required="true" size="30" value="<?php echo $advisory_header; ?>" name="a_header" id="a-header" maxlength="30" class="form-control" placeholder="Enter Advisory Header">
                    
					</p>
					<p class="advisory-edit-form-header-message">                        
                        <input type="hidden" >
                    </p>
									
					
										
					<p class="advisory-edit-form-advisory-name">
                        <label for="name">Name <span class="required">*</span></label>
                        <input type="text" aria-required="true" size="30" value="<?php echo $name; ?>" name="a_name" id="a-name" maxlength="30" class="form-control" placeholder="Enter Name">
                    </p>
					<p class="advisory-edit-form-name-message">                        
                        <input type="hidden" >
                    </p>
					...
					<p class="advisory-edit-form-advisory-message">                        
                        <input type="hidden" >
                    </p>
					<p><img src="user_images/<?php echo $image_path;  ?>" height="250" width="250" id="disp-edit" /></p>
					<td><input class="input-group" type="file" name="user_image" id="a-image" accept="image/*" /></td>
					<p class="advisory-edit-form-image-message">                        
                        <input type="hidden" >
                    </p>
					
					<p class="advisory-edit-form-advisory-designation">
                        <label for="name">Designation <span class="required">*</span></label>
                        <input type="text" aria-required="true" size="4" value="<?php echo htmlspecialchars($designation); ?>" name="a_designation" id="a-designation" maxlength="30" class="form-control" placeholder="Enter Designation">
                    </p>
					<p class="advisory-edit-form-designation-message">                        
                        <input type="hidden" >
                    </p>
									
					
					<p class="advisory-edit-form-advisory-description">
                        <label for="address">Description</label>
                        <textarea aria-required="true" rows="4" cols="45" value="" name="a_description" id="a-description"  class="form-control" placeholder="Enter Description"><?php echo htmlspecialchars($description); ?></textarea>
                    </p>
					<p class="advisory-edit-form-description-message">                        
                        <input type="hidden" >
                    </p>					
...
<div class="preloader">
    <div class="preloader_image"></div>
		...
		<script  src="js/advisories_edit_validator.js"></script>
