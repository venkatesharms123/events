...
$sql = "SELECT userID, news_header, subheading, image_path,
				description FROM news_items
				";
		...
		while($rows = mysqli_fetch_array($result))
			...
			$row_array['news_header'] = $rows['news_header'];
			$row_array['subheading'] = $rows['subheading'];
